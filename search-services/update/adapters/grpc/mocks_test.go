...
//
//	mockgen -source=../../core/ports.go -destination=mocks_test.go -package=grpc
//
...
import (
	...
	core "github.com/liy0aay/xkcd-search/update/core"
...
// PublishDBDropEvent mocks base method.
func (m *MockPublisher) PublishDBDropEvent(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishDBDropEvent", ctx)
	ret0, _ := ret[0].(error)
	return ret0
}

// PublishDBDropEvent indicates an expected call of PublishDBDropEvent.
func (mr *MockPublisherMockRecorder) PublishDBDropEvent(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishDBDropEvent", reflect.TypeOf((*MockPublisher)(nil).PublishDBDropEvent), ctx)
}

// PublishDBUpdateEvent mocks base method.
func (m *MockPublisher) PublishDBUpdateEvent(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishDBUpdateEvent", ctx)
	ret0, _ := ret[0].(error)
	return ret0
}

// PublishDBUpdateEvent indicates an expected call of PublishDBUpdateEvent.
func (mr *MockPublisherMockRecorder) PublishDBUpdateEvent(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishDBUpdateEvent", reflect.TypeOf((*MockPublisher)(nil).PublishDBUpdateEvent), ctx)
}
